...
const styles = StyleSheet.create({
  container: {
    flex: 1, // neemt 1 deel van de beschikbare ruimte, wat gebruikelijker is
    padding: 30, // kleinere en meer gebruikelijke padding
    justifyContent: 'center',
    alignItems: 'center', // voegt ook horizontale centrering toe
    backgroundColor: '#fff',
    maxWidth: 500, // maximale breedte om het visueel compacter te maken
